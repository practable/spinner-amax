...
<div id='options-button'>
    <button type='button' class='button-toolbar button-secondary' id='options-toolbar-button' @click='toggleHelp' aria-label="component options">
        ...
        <div v-if='popup_showing' class="modal" id='modal-show' tabindex="-1">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" id="close-modal" @click="toggleHelp">Close</button>
                </div>
            </div>
            </div>
        </div>
