...
<template>
<div :id='id'>
    <button type='button' class='button-toolbar button-secondary' :id='id + "-button"' @click='toggleHelp' aria-label="component options" data-bs-toggle="tooltip" title="Options">
